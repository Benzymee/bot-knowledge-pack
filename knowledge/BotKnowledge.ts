...
/**
 * Classic Tutorial Island completion kit (tutorial.rs2 `tutorial_skip_finish` kit 0).
 * Inventory stacks + 25gp banked — given to every fresh bot.
 */
export const TUTORIAL_ISLAND_STARTER_INV: ReadonlyArray<readonly [number, number]> = [
    [Items.BRONZE_AXE, 1],
    [Items.TINDERBOX, 1],
...
export const TUTORIAL_ISLAND_BANK_COINS = 25;
...
export const Locations = {
    ...
    /** Primary bot street market — Falador Park (buy/sell hub; see BotMarket.ts). */
    FALADOR_PARK: [2991, 3382, 0] as [number, number, number], // ✅ duck pond / open lawn
    ...
    // LostHQ Mining Guild — south of Falador east bank (60 Mining; 37 coal + 5 mithril)
    MINE_GUILD: [3046, 9757, 0] as [number, number, number], // 🚪 Mining Guild underground (Falador)
    ...
    // LostHQ Fishing Guild — north of East Ardougne (68 Fishing; bank + docks)
    FISH_GUILD: [2604, 3413, 0] as [number, number, number], // ✅ Fishing Guild north dock / bank area
    // LostHQ Cook's Guild — NW Varrock (32 Cooking + chef's hat)
    COOKS_GUILD: [3143, 3443, 0] as [number, number, number], // ✅ Cook's Guild exterior / ranges
    // LostHQ Crafting Guild — south of Falador (40 Crafting + brown apron)
    CRAFTING_GUILD: [2933, 3287, 0] as [number, number, number], // ✅ Crafting Guild gold/silver/clay
    // ── Agility ───────────────────────────────────────────────────────────────
...
export const SkillProgression: Record<string, SkillStep[]> = {
    ...
    FISHING: [
        // LostHQ: small net shrimp — prefer near-bank sea spots (not Karamja for lv1)
        ...
        // Level 20-29: fly rod — trout at Barbarian Village (LostHQ fly fishing)
        {
            minLevel: 20,
            maxLevel: 29,
            action: 'fish',
        ...
        // Level 50-67: harpoon — swordfish at Karamja (boat-routed via Port Sarim)
        { minLevel: 50, maxLevel: 67, action: 'fish', location: Locations.FISH_KARAMJA, toolItemIds: [Items.HARPOON], xpPerAction: 1000, ticksPerAction: 5, successRate: 0.45, itemGained: Items.RAW_SWORDFISH },
        // Level 68+: LostHQ Fishing Guild (bank on site)
        { minLevel: 68, maxLevel: 75, action: 'fish', location: Locations.FISH_GUILD, toolItemIds: [Items.LOBSTER_POT], xpPerAction: 900, ticksPerAction: 5, successRate: 0.55, itemGained: Items.RAW_LOBSTER },
        { minLevel: 68, maxLevel: 99, action: 'fish', location: Locations.FISH_GUILD, toolItemIds: [Items.HARPOON], xpPerAction: 1000, ticksPerAction: 5, successRate: 0.5, itemGained: Items.RAW_SWORDFISH },
        // Level 76-99: harpoon — shark at Catherby / Guild waters
        ...
        { minLevel: 76, maxLevel: 99, action: 'fish', location: Locations.FISH_GUILD, toolItemIds: [Items.HARPOON], xpPerAction: 1100, ticksPerAction: 10, successRate: 0.35, itemGained: Items.RAW_SHARK }
    ],
    ...
    MINING: [
        // LostHQ: copper/tin at Varrock SW/SE + Lumbridge swamp for beginners
        ...
        // Level 15+: iron — LostHQ best XP (SE Varrock / Al Kharid / Barb Village)
        ...
        // Level 30-59: coal at Barbarian Village (LostHQ path before Mining Guild)
        { minLevel: 30, maxLevel: 59, action: 'mine', location: Locations.MINE_DWARVEN, via: Locations.WILLOWS_BARBARIAN_VIA, toolItemIds: [Items.BRONZE_PICKAXE], xpPerAction: 500, ticksPerAction: 6, successRate: 0.45, itemGained: Items.COAL },
        ...
        { minLevel: 1, maxLevel: 14, action: 'mine', location: Locations.MINE_RIMMINGTON, toolItemIds: [Items.BRONZE_PICKAXE], xpPerAction: 50, ticksPerAction: 4, successRate: 0.8, itemGained: Items.CLAY },
        { minLevel: 55, maxLevel: 59, action: 'mine', location: Locations.MINE_MITHRIL, toolItemIds: [Items.BRONZE_PICKAXE], xpPerAction: 800, ticksPerAction: 8, successRate: 0.4, itemGained: Items.MITHRIL_ORE },
        // Level 60+: LostHQ Mining Guild (dense coal + mithril)
        { minLevel: 60, maxLevel: 99, action: 'mine', location: Locations.MINE_GUILD, toolItemIds: [Items.BRONZE_PICKAXE], xpPerAction: 500, ticksPerAction: 6, successRate: 0.55, itemGained: Items.COAL },
        { minLevel: 60, maxLevel: 99, action: 'mine', location: Locations.MINE_GUILD, toolItemIds: [Items.BRONZE_PICKAXE], xpPerAction: 800, ticksPerAction: 8, successRate: 0.45, itemGained: Items.MITHRIL_ORE },
